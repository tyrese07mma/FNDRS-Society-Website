...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "No. A large part of the network is people with skills and no project yet. Joining without an idea is a completely normal way to use FNDRS — plenty of matches start from the other side.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "LinkedIn is optimised for careers: it shows you what someone did. FNDRS is optimised for what someone wants to build next, and what they need to build it. That single difference changes who surfaces, why they surface, and how the first conversation starts.",
  },
  {
    question: "Is FNDRS free?",
    answer:
      "The core — profile, discovery, matching and messaging — is free during the beta. FNDRS Pro is a paid tier for unlimited matching, investor contacts and deeper insights. Pricing will be published before it goes live, and nothing is charged during early access.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "You go on the list and we email you when a spot opens. Access is released in batches so the network stays balanced across skills and regions. No newsletter, no drip campaign.",
  },
  {
    question: "Which languages does FNDRS support?",
    answer:
      "The app ships in English and German, switchable at any time. More languages follow as the network grows.",
  },
];
